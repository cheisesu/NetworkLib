...
extension Tag.HTTP {
    @Tag static var statusCode: Tag
}

@Suite(.tags(.HTTP.all, .HTTP.statusCode))
struct HTTPStatusCodeTests {
    @Test(arguments: HTTPStatusCode.knownPairs)
    ...
    @Test(arguments: HTTPStatusCode.unknownFromExisted)
    ...
    @Test(arguments: HTTPStatusCode.informationalCases)
    ...
    @Test(arguments: HTTPStatusCode.successfulCases)
    ...
    @Test(arguments: HTTPStatusCode.redirectionCases)
    ...
    @Test(arguments: HTTPStatusCode.clientErrorCases)
    ...
    @Test(arguments: HTTPStatusCode.serverErrorCases)
